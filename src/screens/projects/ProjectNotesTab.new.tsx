...
// Імпортуємо покращену обгортку для Bridgeless режиму
...
// Використовуємо безпечну обгортку для Bridgeless режиму
const EnhancedNotesTab = withDatabase(enhance(ProjectNotesTab));
const BridgelessSafeNotesTab = BridgelessSafeComponent(EnhancedNotesTab, 'ProjectNotesTab');

export default BridgelessSafeNotesTab;